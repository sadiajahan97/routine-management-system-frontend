...
import { determineLessonDateTimeColor, Timeline } from '@routine-management-system/lib';
...
export function Lesson({
  ...
  return (
    <div>
      ...
      <div
        className={`${
          isSelected ? (timeline === 'present' ? 'bg-green-g50' : 'bg-neutral-b40') : 'bg-white'
        } border ${
          timeline === 'present' ? 'border-green-g300' : 'border-neutral-b40'
        } flex flex-col gap-3 hover:cursor-pointer p-3 rounded-[12px]`}
        onClick={onClick}>
        <div className='flex flex-col gap-1'>
          <div className='font-semibold text-lg text-neutral-b700'>{subject}</div>
          <div className='font-normal text-base text-neutral-b300'>{chapter}</div>
        </div>
